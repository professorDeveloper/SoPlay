...
fun setAnimation(
    ...
    anim.setInterpolator(context, com.azamovme.soplay.R.anim.over_shoot)
...
fun View.slideTop(animTime: Long, startOffset: Long) {
    val slideUp = AnimationUtils.loadAnimation(App.instance, com.azamovme.soplay.R.anim.slide_top).apply {
        duration = animTime
...
fun animationTransactionClearStack(clearFragmentID: Int): NavOptions.Builder {
    ...
    navBuilder.setEnterAnim(com.azamovme.soplay.R.anim.from_right).setExitAnim(com.azamovme.soplay.R.anim.to_left)
        .setPopEnterAnim(com.azamovme.soplay.R.anim.from_left).setPopExitAnim(com.azamovme.soplay.R.anim.to_right)
...
fun View.slideUp(animTime: Long, startOffset: Long) {
    val slideUp = AnimationUtils.loadAnimation(App.instance, com.azamovme.soplay.R.anim.slide_up).apply {
        duration = animTime
        interpolator = FastOutSlowInInterpolator()
        this.startOffset = startOffset
    }
...
fun View.slideStart(animTime: Long, startOffset: Long, hide: View? = null) {
    val slideUp = AnimationUtils.loadAnimation(App.instance,com.azamovme.soplay. R.anim.slide_start).apply {
